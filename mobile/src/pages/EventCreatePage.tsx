...
const styles = StyleSheet.create({
  ...
  posterButton: { flex: 1, borderWidth: 1, borderColor: '#2563EB', borderRadius: 8, padding: 11, backgroundColor: '#EFF6FF', alignItems: 'center' },
  posterButtonText: { color: '#2563EB', fontWeight: '900' },
  ...
  applyRoundButton: { marginTop: 10, borderWidth: 1, borderColor: '#2563EB', borderRadius: 8, paddingVertical: 11, backgroundColor: '#EFF6FF', alignItems: 'center' },
  applyRoundText: { color: '#2563EB', fontWeight: '900' },
